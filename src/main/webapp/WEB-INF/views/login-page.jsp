...
<form:form name="loginForm" commandName="loginForm" action="/jobsearch/spring/login-user"
	method="POST">
...
%>
	...
	<table align="right" border="1" style="border-color: teal; border-width: 1pt;border-spacing: 0pt">
		...
		<tr style="background: teal;">
		<td>&nbsp;</td>
			<td align="left"><input type="submit" value="Login" />&nbsp;|&nbsp;<a href="../spring/register"><font color="white">Signup</font></a></td>
		</tr>
