...
<html>
 <head>
  ...
  <title>Job Search - Register User</title>
  <style>
	.error {
		color: #ff0000;
	}
      ...
      <table border="1" style="border-color: teal; border-width: 1pt;border-spacing: 0pt">
       ...
       <tr style="background: teal;">
		...
		<div class="errorblock"><font color="red">${error}</font></div></c:if></td></tr>
          <tr>
         <td colspan="2" style="background: teal;"><input type="submit" value="Register"/>&nbsp;<a href="<%=request.getContextPath()%>/spring/login-user" shape="rect" style="color:buttonface;">Login</a></td>
        </tr>
   </table> 
  </form:form>
