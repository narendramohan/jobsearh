...
function CreateDetailView(objArray, theme, enableHeader) {
    ...
    var str='<table><tbody><tr class="alt"><td><input type="button" Value="Back" onclick="goback()"></td></tr></tbody></table>';
    for (var i = 0; i < array.length; i++) {
    	str += '<table id="' + i + '" class="' + theme + '">';
    	str += '<tbody>';
        var row = 0;
        for (var index in array[i]) {
    ...
    str +='<table><tbody><tr class="alt"><td><input type="button" Value="Back" onclick="goback()"></td></tr></tbody></table>';
